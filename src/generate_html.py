...
{{NAV_CSS}}
  ...
  .map-pin{width:14px;height:14px;border-radius:50%;border:2px solid #fff;box-shadow:0 1px 6px rgba(10,53,104,0.4);}
  .map-marker-t{background:#0a3568;}
  .map-marker-p{background:#0096ff;}
  .map-marker-o{background:#dda732;}
  /* clusters : pastilles bleues arrondies */
  .leaflet-marker-cluster{background-clip:padding-box;border-radius:50%;}
  .leaflet-marker-cluster div{width:30px;height:30px;margin-left:5px;margin-top:5px;text-align:center;border-radius:50%;font:600 12px/30px 'Hanken Grotesk','Inter',sans-serif;background:#e8eef7;color:#0a3568;border:2px solid #0a3568;}
  .leaflet-marker-cluster-large div{width:40px;height:40px;margin-left:5px;margin-top:5px;font:600 13px/40px 'Hanken Grotesk','Inter',sans-serif;background:#0a3568;color:#fff;border:none;border-radius:50%;}
